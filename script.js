...
// const totalPages = Math.ceil(dataJson.length / itemsPerPage);
// const paginationControls = document.getElementById("first, previous, num, next, last");
...
function lastPage() {
    userId.innerText = dataJson[99].id;
    userName.innerText = dataJson[99].name;
    userEmail.innerText = dataJson[99].email;
}
